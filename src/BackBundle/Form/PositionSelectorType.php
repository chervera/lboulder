...
class PositionSelectorType extends AbstractType {

    private $api_key = 'AIzaSyAwh_LbIJ1G7xMwamCpt9cHmQfv17cK2uk';
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        if (isset($options['addr_use_btn']) && $options['addr_use_btn']) {
            $builder->add(
                    $options['addr_use_btn']['name'], ButtonType::class, array_merge(
    ...
    public function buildView(FormView $view, FormInterface $form, array $options) {
        ...
        $view->vars['alternative_points'] = $options['alternative_points'];
